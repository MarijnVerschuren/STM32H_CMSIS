...
#ifndef STM32H_CMSIS_USART_H
#define STM32H_CMSIS_USART_H
#include "main.h"
#include "gpio.h"
#include "sys.h"
 ...
 * */
typedef enum {
	USART_CLK_SRC_APBx =		0b000,	//R
	USART_CLK_SRC_PLL2_Q =		0b001,
	USART_CLK_SRC_PLL3_Q =		0b010,
	USART_CLK_SRC_HSI =			0b011,
	USART_CLK_SRC_CSI =			0b100,
	USART_CLK_SRC_LSE =			0b101
} USART_CLK_SRC_t;

typedef enum {
	UART_PIN_DISABLE =	0x00000000,
	// UART1
	USART1_CK_A8 =		0x08070044,		USART1_TX_A9 =		0x09070044,
	USART1_RX_A10 =		0x0A070044,		USART1_CTS_A11 =	0x0B070044,
	USART1_NSS_A11 =	0x0B070044,		USART1_RTS_A12 =	0x0C070044,
	USART1_DE_A12 =		0x0C070044,		USART1_TX_B14 =		0x0E140044,
	USART1_RX_B15 =		0x0F140044,		USART1_TX_B6 =		0x06170044,
	USART1_RX_B7 =		0x07170044,
	// UART2
	USART2_CTS_A0 =		0x00070011,		USART2_NSS_A0 =		0x00070011,
	USART2_RTS_A1 =		0x01070011,		USART2_DE_A1 =		0x01070011,
	USART2_TX_A2 =		0x02070011,		USART2_RX_A3 =		0x03070011,
	USART2_CK_A4 =		0x04070011,		USART2_CTS_D3 =		0x03370011,
	USART2_NSS_D3 =		0x03370011,		USART2_RTS_D4 =		0x04370011,
	USART2_DE_D4 =		0x04370011,		USART2_TX_D5 =		0x05370011,
	USART2_RX_D6 =		0x06370011,		USART2_CK_D7 =		0x07370011,
	// UART3
	USART3_TX_B10 =		0x0A170012,		USART3_RX_B11 =		0x0B170012,
	USART3_CK_B12 =		0x0C170012,		USART3_CTS_B13 =	0x0D170012,
	USART3_NSS_B13 =	0x0D170012,		USART3_RTS_B14 =	0x0E170012,
	USART3_DE_B14 =		0x0E170012,		USART3_TX_C10 =		0x0A270012,
	USART3_RX_C11 =		0x0B270012,		USART3_CK_C12 =		0x0C270012,
	USART3_TX_D8 =		0x08370012,		USART3_RX_D9 =		0x09370012,
	USART3_CK_D10 =		0x0A370012,		USART3_CTS_D11 =	0x0B370012,
	USART3_NSS_D11 =	0x0B370012,		USART3_RTS_D12 =	0x0C370012,
	USART3_DE_D12 =		0x0C370012,
	// UART4
	...
	// UART6
	USART6_TX_C6 =		0x06270045,		USART6_RX_C7 =		0x07270045,
	USART6_CK_C8 =		0x08270045,		USART6_CK_G7 =		0x07670045,
	USART6_RTS_G8 =		0x08670045,		USART6_DE_G8 =		0x08670045,
	USART6_RX_G9 =		0x09670045,		USART6_RTS_G12 =	0x0C670045,
	USART6_DE_G12 =		0x0C670045,		USART6_CTS_G13 =	0x0D670045,
	USART6_NSS_G13 =	0x0D670045,		USART6_TX_G14 =		0x0E670045,
	USART6_CTS_G15 =	0x0F670045,		USART6_NSS_G15 =	0x0F670045,
	// UART7
...
typedef enum {
	USART_STOP_BIT_1 =		0b00,	//R
	USART_STOP_BIT_05 =		0b01,
	USART_STOP_BIT_2 =		0b01,
	USART_STOP_BIT_15 =		0b11
} USART_stop_bit_t;

typedef enum {
	USART_PARITY_DISABLED =	0b00,	//R
	USART_PARITY_EVEN =		0b10,
	USART_PARITY_ODD =		0b11
} USART_parity_t;

typedef enum {
	USART_OVERSAMPLING_16 =	0b0,	//R
	USART_OVERSAMPLING_8 =	0b1
} USART_oversampling_t;

typedef enum {
	USART_WORD_LENGTH_8 =	0b00,	//R
	USART_WORD_LENGTH_9 =	0b01,
	USART_WORD_LENGTH_7 =	0b10
} USART_word_length_t;
