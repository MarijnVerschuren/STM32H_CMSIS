...
typedef enum {
	UART_STOP_BIT_1 =		0b00,	//R
	UART_STOP_BIT_05 =		0b01,
	UART_STOP_BIT_2 =		0b01,
	UART_STOP_BIT_15 =		0b11
} UART_stop_bit_t;

typedef enum {
	UART_PARITY_DISABLED =	0b00,	//R
	UART_PARITY_EVEN =		0b10,
	UART_PARITY_ODD =		0b11
} UART_parity_t;

typedef enum {
	UART_OVERSAMPLING_16 =	0b0,	//R
	UART_OVERSAMPLING_8 =	0b1
} UART_oversampling_t;

typedef enum {
	UART_WORD_LENGTH_8 =	0b00,	//R
	UART_WORD_LENGTH_9 =	0b01,
	UART_WORD_LENGTH_7 =	0b10
} UART_word_length_t;
